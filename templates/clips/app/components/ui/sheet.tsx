...
const sheetVariants = cva(
  "fixed z-[250] gap-4 bg-background p-6 shadow-3d-dialog transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
